  ...
  return (
    ...
    >
      <div className="text-center mb-16">
        <h3 className="text-2xl text-white font-bold">PROJECTS</h3>
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 lg:px-6 px-2 py-1 rounded-xl lg:text-sm font-semibold text-center"
                  >
                    View Code
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-1/2 bg-purple-600 hover:bg-purple-800 text-gray-400 lg:px-6 px-2 py-1 rounded-xl lg:text-sm font-semibold text-center"
                  >
                    View Live
                  </a>
                </div>
